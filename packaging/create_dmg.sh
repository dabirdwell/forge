#!/bin/bash
# Create a DMG installer for NeoVak
...
echo ""
echo "💡 Creating NeoVak DMG installer"
echo ""
...
INSTALLATION:
Drag NeoVak.app to Applications folder

FIRST RUN:
1. Double-click NeoVak in Applications
2. If asked about unidentified developer:
   - Go to System Preferences > Privacy & Security
   - Click "Open Anyway"
3. NeoVak will set up and launch

REQUIREMENTS:
- macOS 11 (Big Sur) or later
- Python 3.10+ (will prompt to install if missing)
- ComfyUI (NeoVak will help you set it up)

MORE INFO:
https://github.com/dabirdwell/neovak
README
